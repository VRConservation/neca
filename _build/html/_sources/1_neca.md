...
6. **Sort yards**. Managing a sort yard for aggregated feedstock would be a strategic revenue source and in line with the JPA mission. This would require substantial investment for equipement and site to start. See the budget for a cost breakdown. A feasibilty study would be helpful to understand total costs, potential revenue and risk reduction associated with the yard.
...
3. Testing, adoption, and implementation of temporal finance mechanisms is included in the GANTT chart timline ({numref}`gantt`).
...
The bulk of the expenses are for labor/staff that includes an executive director, contracted feedstock manager, administrative bookkeeper, and various contracted services. Briefly, the staff responsibilities are the following:
...
4. As revenue is secured, refine the budget and creat a more detailed operating budget